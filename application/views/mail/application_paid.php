<html>
    <body>
        ...
        <p><?php echo $obj['application']->name ?> interested in your apartment</p>
        <p>Email: <?php echo $obj['application']->email ?></p>
        <p>Phone: <?php echo $obj['application']->phone ?></p>
        <p>SIN: <?php echo $obj['application']->sin ?></p>
        <p>References:</p>
